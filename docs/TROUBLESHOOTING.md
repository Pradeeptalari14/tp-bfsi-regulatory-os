# 🔧 Troubleshooting Guide — Agentic AI OS for BFSI (Indian Context)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-bfsi-regulatory-os/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/bfsi-regulatory-os/)
