...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/bfsi-regulatory-os/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-bfsi-regulatory-os.git
cd tp-bfsi-regulatory-os
```
...
```bash
kubectl port-forward deployment/tp-bfsi-regulatory-os 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── bfsi_agent_os.py     # Main configuration file
```
...
---
*Generated by [Agentic AI OS for BFSI (Indian Context) Studio](https://pradeeptalari14.github.io/portfolio/tools/bfsi-regulatory-os/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
