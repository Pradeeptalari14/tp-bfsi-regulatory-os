...
Thank you for your interest in improving the **Agentic AI OS for BFSI (Indian Context)** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-bfsi-regulatory-os.git
...
Generated configurations come from the **[Agentic AI OS for BFSI (Indian Context) Studio](https://pradeeptalari14.github.io/portfolio/tools/bfsi-regulatory-os/)**.
